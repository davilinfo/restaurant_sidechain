...
&nbsp;
export const isPositiveNumberString = <span class="fstat-no" title="function not covered" >(n</span>um: unknown): boolean =&gt; {
<span class="cstat-no" title="statement not covered" >	if (typeof num !== 'string') {</span>
<span class="cstat-no" title="statement not covered" >		return false;</span>
	}
&nbsp;
<span class="cstat-no" title="statement not covered" >	return /^[0-9]+$/g.test(num);</span>
};
&nbsp;
...
&nbsp;
export const isSemVer = <span class="fstat-no" title="function not covered" >(v</span>ersion: string): boolean =&gt; <span class="cstat-no" title="statement not covered" >!!isValidVersion(version);</span>
&nbsp;
...
&nbsp;
	<span class="missing-if-branch" title="else path not taken" >E</span>if (csvAsArray.length &gt; 0) {
		return true;
	}
&nbsp;
<span class="cstat-no" title="statement not covered" >	return false;</span>
...
&nbsp;
export const isValidTransferData = <span class="fstat-no" title="function not covered" >(d</span>ata: string): boolean =&gt;
<span class="cstat-no" title="statement not covered" >	Buffer.byteLength(data, 'utf8') &lt;= MAX_TRANSFER_ASSET_DATA_LENGTH;</span>
&nbsp;
const NETWORK_IDENTIFIER_LENGTH = 32;
export const validateNetworkIdentifier = <span class="fstat-no" title="function not covered" >(n</span>etworkIdentifier: string) =&gt; {
<span class="cstat-no" title="statement not covered" >	if (!networkIdentifier) {</span>
<span class="cstat-no" title="statement not covered" >		throw new Error(`Network identifier can not be empty.`);</span>
	}
	const networkIdentifierBuffer = <span class="cstat-no" title="statement not covered" >hexToBuffer(networkIdentifier);</span>
<span class="cstat-no" title="statement not covered" >	if (networkIdentifierBuffer.length !== NETWORK_IDENTIFIER_LENGTH) {</span>
<span class="cstat-no" title="statement not covered" >		throw new Error(`Invalid network identifier length: ${networkIdentifier}`);</span>
	}
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Fri Feb 07 2020 13:22:45 GMT+0100 (Central European Standard Time)
            </div>
        </div>
