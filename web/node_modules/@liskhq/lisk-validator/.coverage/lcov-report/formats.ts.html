...
<head>
    <title>Code coverage report for formats.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> formats.ts</h1>
        <div class='clearfix'>
...
&nbsp;
export const transferData = <span class="fstat-no" title="function not covered" >(d</span>ata: string): boolean =&gt;
<span class="cstat-no" title="statement not covered" >	!isNullCharacterIncluded(data) &amp;&amp; isValidTransferData(data);</span>
&nbsp;</pre></td></tr></table></pre>
