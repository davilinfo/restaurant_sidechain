...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> errors.ts</h1>
        <div class='clearfix'>
...
export class TransactionError extends Error {
	...
	public constructor(
		message: string = <span class="branch-0 cbranch-no" title="branch not covered" >'',</span>
		id: string = '',
		dataPath: string = '',
...
export const convertToTransactionError = (
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if (!errors) {
