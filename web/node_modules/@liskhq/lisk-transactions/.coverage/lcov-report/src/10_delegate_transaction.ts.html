...
<head>
    <title>Code coverage report for src/10_delegate_transaction.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> 10_delegate_transaction.ts</h1>
        <div class='clearfix'>
...
<span class="fstat-no" title="function not covered" >			(a</span>ccount: Account) =&gt; <span class="cstat-no" title="statement not covered" >account.username === this.asset.username,</span>
		);
&nbsp;
		if (usernameExists) {
			errors.push(
