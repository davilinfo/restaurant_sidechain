...
<head>
    <title>Code coverage report for src/utils/address.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> address.ts</h1>
        <div class='clearfix'>
...
&nbsp;
	return senderId.toUpperCase() !== actualAddress.toUpperCase()
		? <span class="branch-0 cbranch-no" title="branch not covered" >new TransactionError(</span>
