...
<head>
    <title>Code coverage report for src/utils/verify.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> verify.ts</h1>
        <div class='clearfix'>
...
&nbsp;
	return {
		status: MultisignatureStatus.FAIL,
		errors: errors || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span>
	};
};
&nbsp;</pre></td></tr></table></pre>
