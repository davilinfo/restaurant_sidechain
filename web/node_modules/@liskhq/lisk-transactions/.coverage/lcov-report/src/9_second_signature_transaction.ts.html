...
<head>
    <title>Code coverage report for src/9_second_signature_transaction.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> 9_second_signature_transaction.ts</h1>
        <div class='clearfix'>
...
&nbsp;
	public constructor(rawTransaction: unknown) {
		...
		this.asset = (tx.asset || <span class="branch-1 cbranch-no" title="branch not covered" >{ signature: {} })</span> as SecondSignatureAsset;
	}
&nbsp;
