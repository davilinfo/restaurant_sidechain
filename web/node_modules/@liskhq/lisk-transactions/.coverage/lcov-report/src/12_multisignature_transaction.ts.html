...
<head>
    <title>Code coverage report for src/12_multisignature_transaction.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> 12_multisignature_transaction.ts</h1>
        <div class='clearfix'>
...
const setMemberAccounts = async (
	...
	for (const memberPublicKey of membersPublicKeys) {
		...
		const memberAccountWithPublicKey = {
			...memberAccount,
			publicKey: memberAccount.publicKey || <span class="branch-1 cbranch-no" title="branch not covered" >memberPublicKey,</span>
		};
...
&nbsp;
	public constructor(rawTransaction: unknown) {
		...
		const tx = (typeof rawTransaction === 'object' &amp;&amp; rawTransaction !== null
			? rawTransaction
			: <span class="branch-1 cbranch-no" title="branch not covered" >{})</span> as Partial&lt;TransactionJSON&gt;;
		this.asset = (tx.asset || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span> as MultiSignatureAsset;
		...
		this.fee =
			...
			((this.asset.keysgroup &amp;&amp; this.asset.keysgroup.length
				...
				: <span class="branch-1 cbranch-no" title="branch not covered" >BigInt(0))</span> +
				BigInt(1));
	}
&nbsp;
...
&nbsp;
		<span class="missing-if-branch" title="if path not taken" >I</span>if (this.asset.min &gt; this.asset.keysgroup.length) {
...
&nbsp;
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (this.asset.keysgroup.includes(`+${sender.publicKey}`)) {
<span class="cstat-no" title="statement not covered" >			errors.push(</span>
				new TransactionError(
